...
3. Urban Spaces: Characterisation of the urban environments visited and the time spent in different types of spaces.
4. Relationship Between Variables: Exploration of associations between physiological, behavioural, and environmental variables.
5. Geospatial RMSSD Map: Spatial visualisation of RMSSD values to identify patterns of physiological stress and recovery across the city.
